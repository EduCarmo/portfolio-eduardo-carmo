export default function Experiencia() {
    ...
    return (
        <div className="flex flex-col sm:flex-row lg:flex-col ga-6 p-6 items-center justify-around bg-black border border-zinc-800 rounded-2xl">
            <Item principal="+150" label="países atendidos"/>
            <Item principal="+20" label="anos de experiência"/>
            <Item principal="+40" label="projetos"/>
        </div>
    )
}
